  ...
  return (
    <div className="relative h-screen overflow-y-scroll bg-gradient-to-b from-gray-900 via-black to-gray-800 text-white">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute w-[500px] h-[500px] bg-green-500/30 rounded-full blur-3xl animate-pulse top-20 left-10"></div>
        <div className="absolute w-[400px] h-[400px] bg-pink-500/20 rounded-full blur-3xl animate-bounce bottom-20 right-20"></div>
      </div>
      ...
      <svg viewBox="0 0 400 2000" className="absolute w-full h-[2200px] opacity-40">
        <motion.path
          d="M200,0 
        ...
        >
          <div
            ...
            style={{
              background:
                idx < 3
                  ? "linear-gradient(145deg, #34d399, #059669)" // Unlocked (green)
                  : "linear-gradient(145deg, #1f2937, #111827)", // Locked (dark)
